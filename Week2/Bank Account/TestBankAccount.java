public class TestBankAccount {
    public static void main(String[] args) {
        ...
        // check Account1
        System.out.printf("\nAccount 1 Checking balance: $%.2f, Savings balance: $%.2f", account1.getCheckingBalance(), account1.getSavingsBalance());
        
        // check Account2
        System.out.printf("\nAccount 2 Checking balance: $%.2f, Savings balance: $%.2f", account2.getCheckingBalance(), account2.getSavingsBalance());
